...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="margin-top:55px;">
            <div class="col-lg-12">
                ...
                <?php
                    $ctr = 0;
                    foreach($data as $row){
                        echo '<li class="list-group-item" onclick="keDetail('.$row->id.','.$this->uri->segment(3).','.$this->uri->segment(4).');">'
                                .$row->nama_sekolah
        ...
        //                                    + " dalam waktu " + results[j].duration.text  ;
                    ...
                    function keDetail(id,lat,lng){
                        JSInterface.keDetail(id,lat,lng);
                    }
